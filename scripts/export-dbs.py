...
# Example scripts/export-dbs.py build/debug/tools/shell/rag3db dataset.
def main():
    parser = argparse.ArgumentParser(
        description="Export DBs with RAG3DB shell and dataset paths"
    )

    parser.add_argument(
        "--executable", required=True, help="Path to the RAG3DB shell executable"
    )
    parser.add_argument(
