PYPI_URL = "https://pypi.org/pypi/rag3db/json"
CMAKE_KEYWORD = "project(Rag3db VERSION "
CMAKE_SUFFIX = " LANGUAGES CXX C)\n"
EXTENSION_KEYWORD = 'add_definitions(-DRAG3DB_EXTENSION_VERSION="'
EXTENSION_SUFFIX = '")\n'
...
def main():
    ...
    sys.stdout.flush()
    os.system("git config user.email ci@rag3db.com")
    os.system("git config user.name \"Rag3db CI\"")
