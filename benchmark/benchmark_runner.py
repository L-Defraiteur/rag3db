...
rag3db_benchmark_tool = os.path.join(
    base_dir, '..', 'build', 'release', 'tools', 'benchmark', 'rag3db_benchmark')
...
if __name__ == '__main__':
    ...
    is_success = run_rag3db(serialized_graph_path)
