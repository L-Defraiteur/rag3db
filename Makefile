...
ifdef PAGE_SIZE_LOG2
	CMAKE_FLAGS += -DRAG3DB_PAGE_SIZE_LOG2=$(PAGE_SIZE_LOG2)
endif

ifdef DEFAULT_REL_STORAGE_DIRECTION
	CMAKE_FLAGS += -DRAG3DB_DEFAULT_REL_STORAGE_DIRECTION=$(DEFAULT_REL_STORAGE_DIRECTION)
endif

ifdef VECTOR_CAPACITY_LOG2
	CMAKE_FLAGS += -DRAG3DB_VECTOR_CAPACITY_LOG2=$(VECTOR_CAPACITY_LOG2)
endif

ifdef NODE_GROUP_SIZE_LOG2
	CMAKE_FLAGS += -DRAG3DB_NODE_GROUP_SIZE_LOG2=$(NODE_GROUP_SIZE_LOG2)
endif

ifdef MAX_SEGMENT_SIZE_LOG2
	CMAKE_FLAGS += -DRAG3DB_MAX_SEGMENT_SIZE_LOG2=$(MAX_SEGMENT_SIZE_LOG2)
endif
...
java_native_header:
	cmake --build build/$(call get-build-path,Release) --target rag3db_java
...
extension-test: extension-test-build
	...
	aws s3 rm s3://rag3db-dataset-us/${RUN_ID}/ --recursive
