...
#ifndef _RAG3DB_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_
#define _RAG3DB_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_ 1
 ...
 *
 */
class TTransportException : public rag3db_apache::thrift::TException {
public:
  /**
  ...
  TTransportException() : rag3db_apache::thrift::TException(), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type) : rag3db_apache::thrift::TException(), type_(type) {}

  TTransportException(const std::string& message)
    : rag3db_apache::thrift::TException(message), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type, const std::string& message)
    : rag3db_apache::thrift::TException(message), type_(type) {}
...
} // rag3db_apache::thrift::transport

#endif // #ifndef _RAG3DB_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_
