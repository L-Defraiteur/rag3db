...
#ifndef _RAG3DB_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_
...
public:
  ...
  uint32_t readAll(uint8_t* buf, uint32_t len) {
    ...
    return ::rag3db_apache::thrift::transport::readAll(*trans, buf, len);
  }
...
#endif // #ifndef _RAG3DB_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_
