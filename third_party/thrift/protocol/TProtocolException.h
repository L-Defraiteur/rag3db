...
#ifndef _RAG3DB_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
#define _RAG3DB_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_ 1
 ...
 *
 */
class TProtocolException : public rag3db_apache::thrift::TException {
public:
  /**
  ...
  TProtocolException() : rag3db_apache::thrift::TException(), type_(UNKNOWN) {}

  TProtocolException(TProtocolExceptionType type) : rag3db_apache::thrift::TException(), type_(type) {}
...
#endif // #ifndef _RAG3DB_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
