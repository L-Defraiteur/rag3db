...
public:
    ...
    static constexpr const char* referenceRag3dbDocs =
        "For more information, please refer to the official Rag3db documentation: "
        "https://docs.rag3db.com/extensions/llm/\n";
