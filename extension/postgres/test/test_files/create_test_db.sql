...
--
-- Name: rag3db; Type: SCHEMA; Schema: -; Owner: ci
--

CREATE SCHEMA rag3db;


ALTER SCHEMA rag3db OWNER TO ci;
...
--
-- Name: user; Type: TABLE; Schema: rag3db; Owner: ci
--

CREATE TABLE rag3db."user" (
    id integer,
...
ALTER TABLE rag3db."user" OWNER TO ci;
...
--
-- Data for Name: user; Type: TABLE DATA; Schema: rag3db; Owner: ci
--

COPY rag3db."user" (id, org, rate) FROM stdin;
5	apple	4
7	ms	5
9	blackberry	7
\.
