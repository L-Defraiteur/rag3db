...
pub struct CSharpLanguageParser {
    pub language: Language,
    pub extensions: (),
    pub capabilities: ParserCapabilities,
    parser: CSharpScopeExtractionParser,
}

impl CSharpLanguageParser {
    pub fn new() -> Self {
        Self {
            language: Language::Csharp,
            extensions: (),
            capabilities: ParserCapabilities::default(),
            parser: CSharpScopeExtractionParser::new(),
        }
    }
    ...
    fn convert_to_universal_scope(&self, scope: ScopeInfo) -> UniversalScope {
        ...
        lang_specific.insert("csharp".to_string(), json!({
