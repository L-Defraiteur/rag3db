...
pub struct TypeScriptLanguageParser {
    ...
    parser: BaseScopeExtractionParser,
}
...
impl TypeScriptLanguageParser {
    pub fn new() -> Self {
        Self {
            ...
            parser: BaseScopeExtractionParser::new(crate::parallel::parser_worker::SupportedLanguage::Typescript),
        }
    }
    ...
    pub fn parse_file(&self, file_path: &str, content: &str) -> FileAnalysis {
        let scope_analysis = self.parser.parse_file(file_path, content, None);
    ...
    fn convert_to_universal_scope(&self, scope: ScopeInfo) -> UniversalScope {
        ...
        lang_specific.insert("typescript".to_string(), json!({
            ...
            "decoratorDetails": scope.decorator_details,
            "enumMembers": scope.enum_members,
        }));
