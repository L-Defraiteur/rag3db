...
pub struct CppLanguageParser {
    pub language: Language,
    pub extensions: (),
    pub capabilities: ParserCapabilities,
    parser: CppScopeExtractionParser,
}

impl CppLanguageParser {
    pub fn new() -> Self {
        Self {
            language: Language::Cpp,
            extensions: (),
            capabilities: ParserCapabilities::default(),
            parser: CppScopeExtractionParser::new(),
        }
    }
    ...
    fn convert_to_universal_scope(&self, scope: ScopeInfo) -> UniversalScope {
        ...
        lang_specific.insert("cpp".to_string(), json!({
