# Doc 51 — La vision : un chaos contrôlé
...
| un agent | un sous-graphe compilé en workflow (doc 36) — **donc un outil** |
| un backend | un ensemble de graphes plus une surface |
| le catalogue de tout ça | des **entités dans la base** (doc 49) |
...
## 5 bis. Les deux moitiés du moteur — rappel de Lucie
