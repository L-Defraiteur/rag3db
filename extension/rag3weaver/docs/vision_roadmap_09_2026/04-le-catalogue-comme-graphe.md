# 04 — Le catalogue comme graphe : outils, tags, mémoire
...
Suite du doc 36 (`../23-aout-2026-20h33/`) et de la décision de Lucie : *un outil
= un graphe entier + un spécificateur*. Voir aussi [01](01-la-vision.md) pour le
cadre, et [02](02-les-deux-moities.md) pour la raison profonde de traiter les
outils en entités simples et non en KB.
...
| `Scope { org, project }` et le stamp `_org`/`_project` (doc 37, `../23-aout-2026-20h33/`) | le catalogue est **cloisonné par cellule** sans une ligne de plus. L'ontologie d'un locataire est la sienne |
...
| Le **reranker** (doc 47, `../23-aout-2026-20h33/`) et les trois signaux de recherche | de quoi **choisir**, pas seulement retrouver — voir §5, c'est là que ça devient intéressant |
