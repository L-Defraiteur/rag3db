...
using rag3db::function::BuiltInFunctionsUtils;
...
bool UDTTypeInfo::operator==(const rag3db::common::ExtraTypeInfo& other) const {
...
const LogicalType& ListType::getChildType(const rag3db::common::LogicalType& type) {
...
const LogicalType& StructTypeInfo::getChildType(rag3db::common::struct_field_idx_t idx) const {
...
bool LogicalTypeUtils::isNested(rag3db::common::LogicalTypeID logicalTypeID) {
