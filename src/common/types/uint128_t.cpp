...
std::size_t std::hash<rag3db::common::uint128_t>::operator()(
    const rag3db::common::uint128_t& v) const noexcept {
    rag3db::common::hash_t hash = 0;
    rag3db::function::Hash::operation(v, hash);
    return hash;
}
