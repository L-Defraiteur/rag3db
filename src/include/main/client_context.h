 ...
 */
class RAG3DB_API ClientContext {
...
public:
    ...
    AttachedRag3dbDatabase* getAttachedDatabase() const;
    ...
    void setDefaultDatabase(AttachedRag3dbDatabase* defaultDatabase_);
...
private:
    ...
    // Remote database.
    AttachedRag3dbDatabase* remoteDatabase;
    // Progress bar.
