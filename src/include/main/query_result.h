...
public:
     ...
     * again.
     */
    RAG3DB_API virtual std::shared_ptr<processor::FlatTuple> getNext() = 0;
    /**
     * @brief Resets the result tuple iterator.
     */
    RAG3DB_API virtual void resetIterator() = 0;
    /**
     * @return string of first query result.
     */
    RAG3DB_API virtual std::string toString() const = 0;
    /**
     ...
     */
    RAG3DB_API std::unique_ptr<ArrowSchema> getArrowSchema() const;
    /**
     * @return whether there are more arrow chunk to read.
     */
    RAG3DB_API virtual bool hasNextArrowChunk() = 0;
    /**
     ...
     * If converting to another arrow type, this is usually handled automatically.
     */
    RAG3DB_API virtual std::unique_ptr<ArrowArray> getNextArrowChunk(int64_t chunkSize) = 0;
