...
public:
    ...
    // functions.
    static RAG3DB_API Function* matchFunction(const std::string& name,
    ...
    static RAG3DB_API uint32_t getCastCost(common::LogicalTypeID inputTypeID,
        common::LogicalTypeID targetTypeID);

    static RAG3DB_API std::string getFunctionMatchFailureMsg(const std::string name,
