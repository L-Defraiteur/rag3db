...
class RAG3DB_API SparseFrontier : public Frontier {
...
class RAG3DB_API DenseFrontier : public Frontier {
...
class RAG3DB_API DenseSparseDynamicFrontierPair : public FrontierPair {
public:
...
class RAG3DB_API DenseFrontierPair : public FrontierPair {
public:
