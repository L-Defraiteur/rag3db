...
struct RAG3DB_API RelBatchInsertPrintInfo final : OPPrintInfo {
...
struct RAG3DB_API RelBatchInsertProgressSharedState {
...
struct RAG3DB_API RelBatchInsertInfo final : BatchInsertInfo {
 ...
 */
class RAG3DB_API RelBatchInsertImpl {
public:
...
class RAG3DB_API RelBatchInsert : public BatchInsert {
public:
