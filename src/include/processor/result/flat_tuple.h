...
public:
     ...
     */
    RAG3DB_API common::Value& operator[](common::idx_t idx);
     ...
     */
    RAG3DB_API const common::Value& operator[](common::idx_t idx) const;
     ...
     */
    RAG3DB_API std::string toString(const std::vector<uint32_t>& colsWidth,
