...
#ifdef __cplusplus
#define RAG3DB_C_API extern "C" RAG3DB_API
#else
#define RAG3DB_C_API RAG3DB_API
#endif
...
typedef struct {
    ...
    uint32_t thread_qos;
#endif
} rag3db_system_config;

/**
 * @brief rag3db_database manages all database components.
 */
typedef struct {
    void* _database;
} rag3db_database;
...
/**
 * @brief rag3db_connection is used to interact with a Database instance. Each connection is
...
/**
 * @brief rag3db_prepared_statement is a parameterized query which can avoid planning the same query
 * for repeated execution.
 */
typedef struct {
    void* _prepared_statement;
    void* _bound_values;
} rag3db_prepared_statement;

/**
 * @brief rag3db_query_result stores the result of a query.
 */
typedef struct {
    void* _query_result;
...
/**
 * @brief rag3db_flat_tuple stores a vector of values.
 */
typedef struct {
    void* _flat_tuple;
    bool _is_owned_by_cpp;
...
/**
 * @brief rag3db_logical_type is the rag3db internal representation of data types.
 */
typedef struct {
    void* _data_type;
} rag3db_logical_type;
...
/**
 * @brief rag3db_value is used to represent a value with any rag3db internal dataType.
 */
typedef struct {
    void* _value;
    bool _is_owned_by_cpp;
...
/**
 * @brief rag3db internal internal_id type which stores the table_id and offset of a node/rel.
 */
typedef struct {
    uint64_t table_id;
    uint64_t offset;
} rag3db_internal_id_t;

/**
 * @brief rag3db internal date type which stores the number of days since 1970-01-01 00:00:00 UTC.
 */
typedef struct {
...
/**
 * @brief rag3db internal timestamp_ns type which stores the number of nanoseconds since 1970-01-01
 * 00:00:00 UTC.
 */
typedef struct {
    // Nanoseconds since 1970-01-01 00:00:00 UTC.
    int64_t value;
} rag3db_timestamp_ns_t;

/**
 * @brief rag3db internal timestamp_ms type which stores the number of milliseconds since 1970-01-01
 * 00:00:00 UTC.
 */
typedef struct {
    // Milliseconds since 1970-01-01 00:00:00 UTC.
    int64_t value;
} rag3db_timestamp_ms_t;

/**
 * @brief rag3db internal timestamp_sec_t type which stores the number of seconds since 1970-01-01
 * 00:00:00 UTC.
 */
typedef struct {
    // Seconds since 1970-01-01 00:00:00 UTC.
    int64_t value;
} rag3db_timestamp_sec_t;

/**
 * @brief rag3db internal timestamp_tz type which stores the number of microseconds since 1970-01-01
 * with timezone 00:00:00 UTC.
 */
typedef struct {
    // Microseconds since 1970-01-01 00:00:00 UTC.
    int64_t value;
} rag3db_timestamp_tz_t;

/**
 * @brief rag3db internal timestamp type which stores the number of microseconds since 1970-01-01
 * 00:00:00 UTC.
 */
typedef struct {
    // Microseconds since 1970-01-01 00:00:00 UTC.
...
/**
 * @brief rag3db internal interval type which stores the months, days and microseconds.
 */
typedef struct {
    int32_t months;
    int32_t days;
...
/**
 * @brief rag3db_query_summary stores the execution time, plan, compiling time and query options of a
 * query.
 */
typedef struct {
    void* _query_summary;
} rag3db_query_summary;
...
/**
 * @brief enum class for rag3db internal dataTypes.
 */
typedef enum {
    RAG3DB_ANY = 0,
    RAG3DB_NODE = 10,
    RAG3DB_REL = 11,
    RAG3DB_RECURSIVE_REL = 12,
    ...
    RAG3DB_DATE = 34,
    RAG3DB_TIMESTAMP = 35,
    RAG3DB_TIMESTAMP_SEC = 36,
    RAG3DB_TIMESTAMP_MS = 37,
    RAG3DB_TIMESTAMP_NS = 38,
    RAG3DB_TIMESTAMP_TZ = 39,
    RAG3DB_INTERVAL = 40,
    RAG3DB_DECIMAL = 41,
    RAG3DB_INTERNAL_ID = 42,
    // variable size types
    RAG3DB_STRING = 50,
    RAG3DB_BLOB = 51,
    RAG3DB_LIST = 52,
...
/**
 * @brief enum class for rag3db function return state.
 */
typedef enum { Rag3dbSuccess = 0, Rag3dbError = 1 } rag3db_state;

// Database
/**
 * @brief Allocates memory and creates a rag3db database instance at database_path with
 * bufferPoolSize=buffer_pool_size. Caller is responsible for calling rag3db_database_destroy() to
 ...
 */
RAG3DB_C_API rag3db_state rag3db_database_init(const char* database_path,
    rag3db_system_config system_config, rag3db_database* out_database);
/**
 * @brief Destroys the rag3db database instance and frees the allocated memory.
 * @param database The database instance to destroy.
 */
RAG3DB_C_API void rag3db_database_destroy(rag3db_database* database);

RAG3DB_C_API rag3db_system_config rag3db_default_system_config();

// Connection
/**
 * @brief Allocates memory and creates a connection to the database. Caller is responsible for
 * calling rag3db_connection_destroy() to release the allocated memory.
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_connection_init(rag3db_database* database,
    rag3db_connection* out_connection);
/**
 * @brief Destroys the connection instance and frees the allocated memory.
 * @param connection The connection instance to destroy.
 */
RAG3DB_C_API void rag3db_connection_destroy(rag3db_connection* connection);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_connection_set_max_num_thread_for_exec(rag3db_connection* connection,
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_connection_get_max_num_thread_for_exec(rag3db_connection* connection,
    uint64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_connection_query(rag3db_connection* connection, const char* query,
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_connection_prepare(rag3db_connection* connection, const char* query,
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_connection_execute(rag3db_connection* connection,
 ...
 */
RAG3DB_C_API void rag3db_connection_interrupt(rag3db_connection* connection);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_connection_set_query_timeout(rag3db_connection* connection,
 ...
 */
RAG3DB_C_API void rag3db_prepared_statement_destroy(rag3db_prepared_statement* prepared_statement);
/**
 * @return the query is prepared successfully or not.
 */
RAG3DB_C_API bool rag3db_prepared_statement_is_success(rag3db_prepared_statement* prepared_statement);
/**
 * @brief Returns the error message if the prepared statement is not prepared successfully.
 * The caller is responsible for freeing the returned string with `rag3db_destroy_string`.
 ...
 */
RAG3DB_C_API char* rag3db_prepared_statement_get_error_message(
    rag3db_prepared_statement* prepared_statement);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_bool(rag3db_prepared_statement* prepared_statement,
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_int64(
    rag3db_prepared_statement* prepared_statement, const char* param_name, int64_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_int32(
    rag3db_prepared_statement* prepared_statement, const char* param_name, int32_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_int16(
    rag3db_prepared_statement* prepared_statement, const char* param_name, int16_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_int8(rag3db_prepared_statement* prepared_statement,
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_uint64(
    rag3db_prepared_statement* prepared_statement, const char* param_name, uint64_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_uint32(
    rag3db_prepared_statement* prepared_statement, const char* param_name, uint32_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_uint16(
    rag3db_prepared_statement* prepared_statement, const char* param_name, uint16_t value);
/**
 * @brief Binds the given int8_t value to the given parameter name in the prepared statement.
 * @param prepared_statement The prepared statement instance to bind the value.
 * @param param_name The parameter name to bind the value.
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_uint8(
    rag3db_prepared_statement* prepared_statement, const char* param_name, uint8_t value);
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_double(
    rag3db_prepared_statement* prepared_statement, const char* param_name, double value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_float(
    rag3db_prepared_statement* prepared_statement, const char* param_name, float value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_date(rag3db_prepared_statement* prepared_statement,
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_timestamp_ns(
    rag3db_prepared_statement* prepared_statement, const char* param_name, rag3db_timestamp_ns_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_timestamp_sec(
    rag3db_prepared_statement* prepared_statement, const char* param_name,
    rag3db_timestamp_sec_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_timestamp_tz(
    rag3db_prepared_statement* prepared_statement, const char* param_name, rag3db_timestamp_tz_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_timestamp_ms(
    rag3db_prepared_statement* prepared_statement, const char* param_name, rag3db_timestamp_ms_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_timestamp(
    rag3db_prepared_statement* prepared_statement, const char* param_name, rag3db_timestamp_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_interval(
    rag3db_prepared_statement* prepared_statement, const char* param_name, rag3db_interval_t value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_string(
    rag3db_prepared_statement* prepared_statement, const char* param_name, const char* value);
/**
 * @brief Binds the given rag3db value to the given parameter name in the prepared statement.
 * @param prepared_statement The prepared statement instance to bind the value.
 * @param param_name The parameter name to bind the value.
 * @param value The rag3db value to bind.
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_prepared_statement_bind_value(
    rag3db_prepared_statement* prepared_statement, const char* param_name, rag3db_value* value);
 ...
 */
RAG3DB_C_API void rag3db_query_result_destroy(rag3db_query_result* query_result);
/**
 ...
 */
RAG3DB_C_API bool rag3db_query_result_is_success(rag3db_query_result* query_result);
/**
 ...
 */
RAG3DB_C_API char* rag3db_query_result_get_error_message(rag3db_query_result* query_result);
/**
 * @brief Returns the number of columns in the query result.
 * @param query_result The query result instance to return.
 */
RAG3DB_C_API uint64_t rag3db_query_result_get_num_columns(rag3db_query_result* query_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_query_result_get_column_name(rag3db_query_result* query_result,
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_query_result_get_column_data_type(rag3db_query_result* query_result,
    uint64_t index, rag3db_logical_type* out_column_data_type);
/**
 * @brief Returns the number of tuples in the query result.
 * @param query_result The query result instance to return.
 */
RAG3DB_C_API uint64_t rag3db_query_result_get_num_tuples(rag3db_query_result* query_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_query_result_get_query_summary(rag3db_query_result* query_result,
 ...
 * @param query_result The query result instance to check.
 */
RAG3DB_C_API bool rag3db_query_result_has_next(rag3db_query_result* query_result);
/**
 * @brief Returns the next tuple in the query result. Throws an exception if there is no more tuple.
 * Note that to reduce resource allocation, all calls to rag3db_query_result_get_next() reuse the same
 * FlatTuple object. Since its contents will be overwritten, please complete processing a FlatTuple
 * or make a copy of its data before calling rag3db_query_result_get_next() again.
 * @param query_result The query result instance to return.
 * @param[out] out_flat_tuple The output parameter that will hold the next tuple.
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_query_result_get_next(rag3db_query_result* query_result,
 ...
 * @param query_result The query result instance to check.
 */
RAG3DB_C_API bool rag3db_query_result_has_next_query_result(rag3db_query_result* query_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_query_result_get_next_query_result(rag3db_query_result* query_result,
    rag3db_query_result* out_next_query_result);
 ...
 */
RAG3DB_C_API char* rag3db_query_result_to_string(rag3db_query_result* query_result);
/**
 ...
 */
RAG3DB_C_API void rag3db_query_result_reset_iterator(rag3db_query_result* query_result);
 ...
 */
RAG3DB_C_API rag3db_state rag3db_query_result_get_arrow_schema(rag3db_query_result* query_result,
 ...
 * It is the caller's responsibility to call the release function to release the underlying data
 */
RAG3DB_C_API rag3db_state rag3db_query_result_get_next_arrow_chunk(rag3db_query_result* query_result,
 ...
 */
RAG3DB_C_API void rag3db_flat_tuple_destroy(rag3db_flat_tuple* flat_tuple);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_flat_tuple_get_value(rag3db_flat_tuple* flat_tuple, uint64_t index,
 ...
 */
RAG3DB_C_API char* rag3db_flat_tuple_to_string(rag3db_flat_tuple* flat_tuple);
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API void rag3db_data_type_create(rag3db_data_type_id id, rag3db_logical_type* child_type,
    uint64_t num_elements_in_array, rag3db_logical_type* out_type);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API void rag3db_data_type_clone(rag3db_logical_type* data_type, rag3db_logical_type* out_type);
/**
 * @brief Destroys the given data type instance.
 * @param data_type The data type instance to destroy.
 */
RAG3DB_C_API void rag3db_data_type_destroy(rag3db_logical_type* data_type);
/**
 ...
 */
RAG3DB_C_API bool rag3db_data_type_equals(rag3db_logical_type* data_type1, rag3db_logical_type* data_type2);
/**
 * @brief Returns the enum type id of the given data type.
 * @param data_type The data type instance to return.
 */
RAG3DB_C_API rag3db_data_type_id rag3db_data_type_get_id(rag3db_logical_type* data_type);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_data_type_get_num_elements_in_array(rag3db_logical_type* data_type,
    uint64_t* out_result);
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_null();
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_null_with_data_type(rag3db_logical_type* data_type);
/**
 * @brief Returns true if the given value is NULL, false otherwise.
 * @param value The value instance to check.
 */
RAG3DB_C_API bool rag3db_value_is_null(rag3db_value* value);
/**
 ...
 */
RAG3DB_C_API void rag3db_value_set_null(rag3db_value* value, bool is_null);
/**
 ...
 * @param data_type The data type of the value to create.
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_default(rag3db_logical_type* data_type);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_bool(bool val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_int8(int8_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_int16(int16_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_int32(int32_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_int64(int64_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_uint8(uint8_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_uint16(uint16_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_uint32(uint32_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_uint64(uint64_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_int128(rag3db_int128_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_float(float val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_double(double val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_internal_id(rag3db_internal_id_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_date(rag3db_date_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_timestamp_ns(rag3db_timestamp_ns_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_timestamp_ms(rag3db_timestamp_ms_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_timestamp_sec(rag3db_timestamp_sec_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_timestamp_tz(rag3db_timestamp_tz_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_timestamp(rag3db_timestamp_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_interval(rag3db_interval_t val_);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_create_string(const char* val_);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_create_list(uint64_t num_elements, rag3db_value** elements,
    rag3db_value** out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_create_struct(uint64_t num_fields, const char** field_names,
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_create_map(uint64_t num_fields, rag3db_value** keys,
    rag3db_value** values, rag3db_value** out_value);
/**
 ...
 */
RAG3DB_C_API rag3db_value* rag3db_value_clone(rag3db_value* value);
/**
 * @brief Copies the other value to the value.
 * @param value The value to copy to.
 * @param other The value to copy from.
 */
RAG3DB_C_API void rag3db_value_copy(rag3db_value* value, rag3db_value* other);
/**
 * @brief Destroys the value.
 * @param value The value to destroy.
 */
RAG3DB_C_API void rag3db_value_destroy(rag3db_value* value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_list_size(rag3db_value* value, uint64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_list_element(rag3db_value* value, uint64_t index,
    rag3db_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_struct_num_fields(rag3db_value* value, uint64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_struct_field_name(rag3db_value* value, uint64_t index,
    char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_struct_field_value(rag3db_value* value, uint64_t index,
    rag3db_value* out_value);
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_map_size(rag3db_value* value, uint64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_map_key(rag3db_value* value, uint64_t index,
    rag3db_value* out_key);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_map_value(rag3db_value* value, uint64_t index,
    rag3db_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_recursive_rel_node_list(rag3db_value* value,
    rag3db_value* out_value);
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_recursive_rel_rel_list(rag3db_value* value,
    rag3db_value* out_value);
/**
 ...
 */
RAG3DB_C_API void rag3db_value_get_data_type(rag3db_value* value, rag3db_logical_type* out_type);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_bool(rag3db_value* value, bool* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_int8(rag3db_value* value, int8_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_int16(rag3db_value* value, int16_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_int32(rag3db_value* value, int32_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_int64(rag3db_value* value, int64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_uint8(rag3db_value* value, uint8_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_uint16(rag3db_value* value, uint16_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_uint32(rag3db_value* value, uint32_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_uint64(rag3db_value* value, uint64_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_int128(rag3db_value* value, rag3db_int128_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_int128_t_from_string(const char* str, rag3db_int128_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_int128_t_to_string(rag3db_int128_t val, char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_float(rag3db_value* value, float* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_double(rag3db_value* value, double* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_internal_id(rag3db_value* value, rag3db_internal_id_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_date(rag3db_value* value, rag3db_date_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_timestamp(rag3db_value* value, rag3db_timestamp_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_timestamp_ns(rag3db_value* value,
    rag3db_timestamp_ns_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_timestamp_ms(rag3db_value* value,
    rag3db_timestamp_ms_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_timestamp_sec(rag3db_value* value,
    rag3db_timestamp_sec_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_timestamp_tz(rag3db_value* value,
    rag3db_timestamp_tz_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_interval(rag3db_value* value, rag3db_interval_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_decimal_as_string(rag3db_value* value, char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_string(rag3db_value* value, char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_blob(rag3db_value* value, uint8_t** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_value_get_uuid(rag3db_value* value, char** out_result);
/**
 * @brief Converts the given value to string.
 * @param value The value to convert.
 * @return The value as a string.
 */
RAG3DB_C_API char* rag3db_value_to_string(rag3db_value* value);
/**
 * @brief Returns the internal id value of the given node value as a rag3db value.
 * @param node_val The node value to return.
 * @param[out] out_value The output parameter that will hold the internal id value.
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_node_val_get_id_val(rag3db_value* node_val, rag3db_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_node_val_get_label_val(rag3db_value* node_val, rag3db_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_node_val_get_property_size(rag3db_value* node_val, uint64_t* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_node_val_get_property_name_at(rag3db_value* node_val, uint64_t index,
    char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_node_val_get_property_value_at(rag3db_value* node_val, uint64_t index,
    rag3db_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_node_val_to_string(rag3db_value* node_val, char** out_result);
/**
 * @brief Returns the internal id value of the rel value as a rag3db value.
 * @param rel_val The rel value to return.
 * @param[out] out_value The output parameter that will hold the internal id value.
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_rel_val_get_id_val(rag3db_value* rel_val, rag3db_value* out_value);
/**
 * @brief Returns the internal id value of the source node of the given rel value as a rag3db value.
 * @param rel_val The rel value to return.
 * @param[out] out_value The output parameter that will hold the internal id value.
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_rel_val_get_src_id_val(rag3db_value* rel_val, rag3db_value* out_value);
/**
 * @brief Returns the internal id value of the destination node of the given rel value as a rag3db
 * value.
 * @param rel_val The rel value to return.
 * @param[out] out_value The output parameter that will hold the internal id value.
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_rel_val_get_dst_id_val(rag3db_value* rel_val, rag3db_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_rel_val_get_label_val(rag3db_value* rel_val, rag3db_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_rel_val_get_property_size(rag3db_value* rel_val, uint64_t* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_rel_val_get_property_name_at(rag3db_value* rel_val, uint64_t index,
    char** out_result);
/**
 * @brief Returns the property of the given rel value at the given index as rag3db value.
 * @param rel_val The rel value to return.
 * @param index The index of the property.
 * @param[out] out_value The output parameter that will hold the property value at index.
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_rel_val_get_property_value_at(rag3db_value* rel_val, uint64_t index,
    rag3db_value* out_value);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_rel_val_to_string(rag3db_value* rel_val, char** out_result);
/**
 * @brief Destroys any string created by the Rag3db C API, including both the error message and the
 ...
 */
RAG3DB_C_API void rag3db_destroy_string(char* str);
/**
 * @brief Destroys any blob created by the Rag3db C API. This function is provided to avoid the
 ...
 */
RAG3DB_C_API void rag3db_destroy_blob(uint8_t* blob);
 ...
 */
RAG3DB_C_API void rag3db_query_summary_destroy(rag3db_query_summary* query_summary);
/**
 ...
 */
RAG3DB_C_API double rag3db_query_summary_get_compiling_time(rag3db_query_summary* query_summary);
/**
 ...
 */
RAG3DB_C_API double rag3db_query_summary_get_execution_time(rag3db_query_summary* query_summary);
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_timestamp_ns_to_tm(rag3db_timestamp_ns_t timestamp, struct tm* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_timestamp_ms_to_tm(rag3db_timestamp_ms_t timestamp, struct tm* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_timestamp_sec_to_tm(rag3db_timestamp_sec_t timestamp,
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_timestamp_tz_to_tm(rag3db_timestamp_tz_t timestamp, struct tm* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_timestamp_to_tm(rag3db_timestamp_t timestamp, struct tm* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_timestamp_ns_from_tm(struct tm tm, rag3db_timestamp_ns_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_timestamp_ms_from_tm(struct tm tm, rag3db_timestamp_ms_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_timestamp_sec_from_tm(struct tm tm, rag3db_timestamp_sec_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_timestamp_tz_from_tm(struct tm tm, rag3db_timestamp_tz_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_timestamp_from_tm(struct tm tm, rag3db_timestamp_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_date_to_string(rag3db_date_t date, char** out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_date_from_string(const char* str, rag3db_date_t* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_date_to_tm(rag3db_date_t date, struct tm* out_result);
/**
 ...
 * @return The state indicating the success or failure of the operation.
 */
RAG3DB_C_API rag3db_state rag3db_date_from_tm(struct tm tm, rag3db_date_t* out_result);
/**
 ...
 */
RAG3DB_C_API void rag3db_interval_to_difftime(rag3db_interval_t interval, double* out_result);
/**
 * @brief Convert difftime value in seconds to interval.
 * @param difftime The difftime value to convert.
 * @param[out] out_result The output parameter that will hold the interval value.
 */
RAG3DB_C_API void rag3db_interval_from_difftime(double difftime, rag3db_interval_t* out_result);

// Version
/**
 * @brief Returns the version of the Rag3db library.
 */
RAG3DB_C_API char* rag3db_get_version();

/**
 * @brief Returns the storage version of the Rag3db library.
 */
RAG3DB_C_API uint64_t rag3db_get_storage_version();
#undef RAG3DB_C_API
