...
struct RAG3DB_API RelTableInsertState : TableInsertState {
...
struct RAG3DB_API RelTableDeleteState final : TableDeleteState {
    common::ValueVector& srcNodeIDVector;
    common::ValueVector& dstNodeIDVector;
    common::ValueVector& relIDVector;
...
class RAG3DB_API RelTable final : public Table {
public:
