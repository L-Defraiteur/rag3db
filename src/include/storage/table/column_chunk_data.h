...
class RAG3DB_API ColumnChunkData {
public:
    ...
    static common::page_idx_t getNumPagesForBytes(uint64_t numBytes) {
        return (numBytes + common::RAG3DB_PAGE_SIZE - 1) / common::RAG3DB_PAGE_SIZE;
    }
    ...
    // RAG3DB_PAGE_SIZE == MAX_SEGMENT_SIZE, even a normal column with non-constant-compressed nulls
...
class RAG3DB_API InternalIDChunkData final : public ColumnChunkData {
public:
