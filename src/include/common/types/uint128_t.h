...
RAG3DB_API uint128_t operator+(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API uint128_t operator-(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API uint128_t operator*(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API uint128_t operator/(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API uint128_t operator%(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API uint128_t operator^(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API uint128_t operator&(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API uint128_t operator~(const uint128_t& val);
RAG3DB_API uint128_t operator|(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API uint128_t operator<<(const uint128_t& lhs, int amount);
RAG3DB_API uint128_t operator>>(const uint128_t& lhs, int amount);

// comparison operators
RAG3DB_API bool operator==(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API bool operator!=(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API bool operator>(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API bool operator>=(const uint128_t& lhs, const uint128_t& rhs);
RAG3DB_API bool operator<(const uint128_t& lhs, const uint128_t& rhs);
...
template<>
struct std::hash<rag3db::common::uint128_t> {
    std::size_t operator()(const rag3db::common::uint128_t& v) const noexcept;
};
