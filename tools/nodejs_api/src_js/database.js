...
class Database {
  ...
  constructor(
    ...
    this._database = new Rag3dbNative.NodeDatabase(
      databasePath,
      bufferManagerSize,
      enableCompression,
      readOnly,
   ...
   */
  static getVersion() {
    return Rag3dbNative.NodeDatabase.getVersion();
  }
  ...
  static getStorageVersion() {
    return Rag3dbNative.NodeDatabase.getStorageVersion();
  }
   ...
   * @returns {Rag3dbNative.NodeDatabase} the underlying native database.
