...
/**
 * Union type representing all possible value types in Rag3db.
 */
export type Rag3dbValue =
    | null
    | boolean
    | number
    | bigint
...
/**
 * Represents a Rag3db database instance.
 */
export class Database {
    ...
    /**
     * Get the version of the Rag3db library.
     * @returns The version string of the library
     */
    static getVersion(): string;

    /**
     * Get the storage version of the Rag3db library.
...
/**
 * Represents a connection to a Rag3db database.
 */
export class Connection {
    ...
    execute(
        ...
        params?: Record<string, Rag3dbValue>,
...
export class QueryResult {
     ...
     */
    getNext(): Promise<Record<string, Rag3dbValue> | null>;

    /**
     * Get the next row synchronously.
     * @returns The next row or null if no more rows
     */
    getNextSync(): Record<string, Rag3dbValue> | null;
     ...
     */
    each(
        resultCallback: (row: Record<string, Rag3dbValue>) => void,
        doneCallback: () => void,
     ...
     */
    getAll(): Promise<Record<string, Rag3dbValue>[]>;

    /**
     * Get all rows of the query result synchronously.
     * @returns All rows of the query result
     */
    getAllSync(): Record<string, Rag3dbValue>[];
     ...
     */
    all(
        resultCallback: (rows: Record<string, Rag3dbValue>[]) => void,
        errorCallback: (error: Error) => void
    ): void;
...
/**
 * Default export for the Rag3db module.
 */
declare const rag3db: {
