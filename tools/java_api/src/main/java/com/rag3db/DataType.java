...
/**
 * DataType is the rag3db internal representation of data types.
 */
public class DataType implements AutoCloseable {
     ...
     *
     * @param id: the rag3db internal representation of data type IDs.
     */
    public DataType(DataTypeID id) {
        dt_ref = Native.rag3dbDataTypeCreate(id, null, 0);
    }

    public DataType
            (DataTypeID id, DataType child_type, long num_elements_in_array) {
        dt_ref = Native.rag3dbDataTypeCreate(id, child_type, num_elements_in_array);
    }
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.rag3dbDataTypeDestroy(this);
        destroyed = true;
    }
    ...
    public DataType clone() {
        if (destroyed)
            ...
            return Native.rag3dbDataTypeClone(this);
    }
    ...
    public boolean equals(DataType other) {
        checkNotDestroyed();
        return Native.rag3dbDataTypeEquals(this, other);
    }
    ...
    public DataTypeID getID() {
        checkNotDestroyed();
        return Native.rag3dbDataTypeGetId(this);
    }
    ...
    public DataType getChildType() {
        checkNotDestroyed();
        return Native.rag3dbDataTypeGetChildType(this);
    }
    ...
    public long getFixedNumElementsInList() {
        checkNotDestroyed();
        return Native.rag3dbDataTypeGetNumElementsInArray(this);
    }
