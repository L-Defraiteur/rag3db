...
public class Rag3dbStruct implements AutoCloseable {
     ...
     */
    public Rag3dbStruct(Value value) {
        structVal = value;
    }
     ...
     */
    public Rag3dbStruct(Map<String, Value> fields) {
        if (fields.isEmpty()) {
            structVal = null;
            return;
        }
        ...
        structVal = Native.rag3dbCreateStruct(fieldNames, fieldValues);
    }
     ...
     */
    public Rag3dbStruct(String[] fieldNames, Value[] fieldValues) {
    ...
    public long getNumFields() {
        ...
        return Native.rag3dbValueGetListSize(structVal);
    }
    ...
    public long getIndexByFieldName(String fieldName) {
        ...
        return Native.rag3dbValueGetStructIndex(structVal, fieldName);
    }
    ...
    public String getFieldNameByIndex(long index) {
        ...
        return Native.rag3dbValueGetStructFieldName(structVal, index);
    }
    ...
    public Value getValueByIndex(long index) {
        ...
        return Native.rag3dbValueGetListElement(structVal, index);
    }
