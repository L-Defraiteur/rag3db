...
public class QueryResult implements AutoCloseable {
    ...
    private void destroy() {
        checkNotDestroyed();
        if (!isOwnedByCPP) {
            Native.rag3dbQueryResultDestroy(this);
            destroyed = true;
        }
    }
    ...
    public boolean isSuccess() {
        checkNotDestroyed();
        return Native.rag3dbQueryResultIsSuccess(this);
    }
    ...
    public String getErrorMessage() {
        checkNotDestroyed();
        return Native.rag3dbQueryResultGetErrorMessage(this);
    }
    ...
    public long getNumColumns() {
        checkNotDestroyed();
        return Native.rag3dbQueryResultGetNumColumns(this);
    }
    ...
    public String getColumnName(long index) {
        checkNotDestroyed();
        return Native.rag3dbQueryResultGetColumnName(this, index);
    }
    ...
    public DataType getColumnDataType(long index) {
        checkNotDestroyed();
        return Native.rag3dbQueryResultGetColumnDataType(this, index);
    }
    ...
    public long getNumTuples() {
        checkNotDestroyed();
        return Native.rag3dbQueryResultGetNumTuples(this);
    }
    ...
    public QuerySummary getQuerySummary() {
        checkNotDestroyed();
        return Native.rag3dbQueryResultGetQuerySummary(this);
    }
    ...
    public boolean hasNext() {
        checkNotDestroyed();
        return Native.rag3dbQueryResultHasNext(this);
    }
    ...
    public FlatTuple getNext() {
        checkNotDestroyed();
        return Native.rag3dbQueryResultGetNext(this);
    }
    ...
    public boolean hasNextQueryResult() {
        checkNotDestroyed();
        return Native.rag3dbQueryResultHasNextQueryResult(this);
    }
    ...
    public QueryResult getNextQueryResult() {
        checkNotDestroyed();
        return Native.rag3dbQueryResultGetNextQueryResult(this);
    }
    ...
    public String toString() {
        if (destroyed)
            ...
            return Native.rag3dbQueryResultToString(this);
    }
    ...
    public void resetIterator() {
        checkNotDestroyed();
        Native.rag3dbQueryResultResetIterator(this);
    }
}
