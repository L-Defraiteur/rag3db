...
/**
 * The Database class is the main class of Rag3dbDB. It manages all database
 * components.
 */
public class Database implements AutoCloseable {
    ...
    public Database(String databasePath) {
        ...
        db_ref = Native.rag3dbDatabaseInit(databasePath, 0, true, false, max_db_size, autoCheckpoint,
     ...
     *                                  will throw an error. Otherwise, Rag3db will silently ignore
    ...
    public Database(String databasePath, long bufferPoolSize, boolean enableCompression, boolean readOnly,
        ...
        db_ref = Native.rag3dbDatabaseInit(databasePath, bufferPoolSize, enableCompression, readOnly, maxDBSize,
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.rag3dbDatabaseDestroy(this);
        destroyed = true;
    }
}
