...
public class Connection implements AutoCloseable {
    ...
    public Connection(Database db) {
        ...
        conn_ref = Native.rag3dbConnectionInit(db);
    }
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.rag3dbConnectionDestroy(this);
        destroyed = true;
    }
    ...
    public long getMaxNumThreadForExec() {
        checkNotDestroyed();
        return Native.rag3dbConnectionGetMaxNumThreadForExec(this);
    }
    ...
    public void setMaxNumThreadForExec(long numThreads) {
        checkNotDestroyed();
        Native.rag3dbConnectionSetMaxNumThreadForExec(this, numThreads);
    }
    ...
    public QueryResult query(String queryStr) {
        checkNotDestroyed();
        return Native.rag3dbConnectionQuery(this, queryStr);
    }
    ...
    public PreparedStatement prepare(String queryStr) {
        checkNotDestroyed();
        return Native.rag3dbConnectionPrepare(this, queryStr);
    }
    ...
    public QueryResult execute(PreparedStatement ps, Map<String, Value> m) {
        checkNotDestroyed();
        return Native.rag3dbConnectionExecute(this, ps, m);
    }
    ...
    public void interrupt() {
        checkNotDestroyed();
        Native.rag3dbConnectionInterrupt(this);
    }
    ...
    public void setQueryTimeout(long timeoutInMs) {
        checkNotDestroyed();
        Native.rag3dbConnectionSetQueryTimeout(this, timeoutInMs);
    }
}
