...
public class PreparedStatement implements AutoCloseable {
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.rag3dbPreparedStatementDestroy(this);
        destroyed = true;
    }
    ...
    public boolean isSuccess() {
        checkNotDestroyed();
        return Native.rag3dbPreparedStatementIsSuccess(this);
    }
    ...
    public String getErrorMessage() {
        checkNotDestroyed();
        return Native.rag3dbPreparedStatementGetErrorMessage(this);
    }
