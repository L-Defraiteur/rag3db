...
public class Value implements AutoCloseable {
    ...
    public <T> Value(T val) {
        checkNotDestroyed();
        v_ref = Native.rag3dbValueCreateValue(val);
    }
    ...
    public static Value createNull() {
        return Native.rag3dbValueCreateNull();
    }
    ...
    public static Value createNullWithDataType(DataType data_type) {
        return Native.rag3dbValueCreateNullWithDataType(data_type);
    }
    ...
    public static Value createDefault(DataType data_type) {
        return Native.rag3dbValueCreateDefault(data_type);
    }
    ...
    private void destroy() {
        checkNotDestroyed();
        if (!isOwnedByCPP) {
            Native.rag3dbValueDestroy(this);
            destroyed = true;
        }
    }
    ...
    public boolean isNull() {
        checkNotDestroyed();
        return Native.rag3dbValueIsNull(this);
    }
    ...
    public void setNull(boolean flag) {
        checkNotDestroyed();
        Native.rag3dbValueSetNull(this, flag);
    }
    ...
    public void copy(Value other) {
        checkNotDestroyed();
        Native.rag3dbValueCopy(this, other);
    }
    ...
    public Value clone() {
        if (destroyed)
            ...
            return Native.rag3dbValueClone(this);
    }
    ...
    public <T> T getValue() {
        checkNotDestroyed();
        return Native.rag3dbValueGetValue(this);
    }
    ...
    public DataType getDataType() {
        checkNotDestroyed();
        return Native.rag3dbValueGetDataType(this);
    }
    ...
    public String toString() {
        if (destroyed)
            ...
            return Native.rag3dbValueToString(this);
    }
}
