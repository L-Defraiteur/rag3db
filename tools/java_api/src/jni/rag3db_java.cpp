...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbNativeReloadLibrary(JNIEnv* env, jclass,
    jstring libPath) {
    try {
#ifdef _WIN32
// Do nothing on Windows
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbDatabaseInit(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbDatabaseDestroy(JNIEnv* env, jclass,
    jobject thisDB) {
    try {
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbConnectionInit(JNIEnv* env, jclass, jobject db) {
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbConnectionDestroy(JNIEnv* env, jclass,
    jobject thisConn) {
    try {
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbConnectionSetMaxNumThreadForExec(JNIEnv* env,
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbConnectionGetMaxNumThreadForExec(JNIEnv* env,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbConnectionQuery(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbConnectionPrepare(JNIEnv* env, jclass,
    jobject thisConn, jstring query) {
    try {
        Connection* conn = getConnection(env, thisConn);
        std::string cppQuery = jstringToUtf8String(env, query);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbConnectionExecute(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbConnectionInterrupt(JNIEnv* env, jclass,
    jobject thisConn) {
    try {
        Connection* conn = getConnection(env, thisConn);
        conn->interrupt();
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbConnectionSetQueryTimeout(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbPreparedStatementDestroy(JNIEnv* env, jclass,
    jobject thisPS) {
    try {
...
JNIEXPORT jboolean JNICALL Java_com_rag3db_Native_rag3dbPreparedStatementIsSuccess(JNIEnv* env,
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbPreparedStatementGetErrorMessage(JNIEnv* env,
    jclass, jobject thisPS) {
    try {
        PreparedStatement* ps = getPreparedStatement(env, thisPS);
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbQueryResultDestroy(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
...
JNIEXPORT jboolean JNICALL Java_com_rag3db_Native_rag3dbQueryResultIsSuccess(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbQueryResultGetErrorMessage(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbQueryResultGetNumColumns(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbQueryResultGetColumnName(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbQueryResultGetColumnDataType(JNIEnv* env,
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbQueryResultGetNumTuples(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbQueryResultGetQuerySummary(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jboolean JNICALL Java_com_rag3db_Native_rag3dbQueryResultHasNext(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbQueryResultGetNext(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jboolean JNICALL Java_com_rag3db_Native_rag3dbQueryResultHasNextQueryResult(JNIEnv* env,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbQueryResultGetNextQueryResult(JNIEnv* env,
    jclass, jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbQueryResultToString(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbQueryResultResetIterator(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
        qr->resetIterator();
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbFlatTupleDestroy(JNIEnv* env, jclass,
    jobject thisFT) {
    try {
        jlong fieldValue = env->GetLongField(thisFT, J_C_FlatTuple_F_ft_ref);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbFlatTupleGetValue(JNIEnv* env, jclass,
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbFlatTupleToString(JNIEnv* env, jclass,
    jobject thisFT) {
    try {
        FlatTuple* ft = getFlatTuple(env, thisFT);
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbDataTypeCreate(JNIEnv* env, jclass, jobject id,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbDataTypeClone(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbDataTypeDestroy(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
...
JNIEXPORT jboolean JNICALL Java_com_rag3db_Native_rag3dbDataTypeEquals(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbDataTypeGetId(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
        auto* dt = getDataType(env, thisDT);
        std::string idStr = dataTypeToString(*dt);
        jfieldID idField =
            env->GetStaticFieldID(J_C_DataTypeID, idStr.c_str(), "Lcom/rag3db/DataTypeID;");
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbDataTypeGetChildType(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbDataTypeGetNumElementsInArray(JNIEnv* env,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbValueCreateNull(JNIEnv* env, jclass) {
    try {
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbValueCreateNullWithDataType(JNIEnv* env,
...
JNIEXPORT jboolean JNICALL Java_com_rag3db_Native_rag3dbValueIsNull(JNIEnv* env, jclass,
    jobject thisV) {
    try {
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbValueSetNull(JNIEnv* env, jclass, jobject thisV,
    jboolean isNull) {
    try {
        Value* v = getValue(env, thisV);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbValueCreateDefault(JNIEnv* env, jclass,
    jobject dataType) {
    try {
        auto* dt = getDataType(env, dataType);
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbValueCreateValue(JNIEnv* env, jclass,
    jobject val) {
    try {
        Value* v = nullptr;
        if (env->IsInstanceOf(val, J_C_Boolean)) {
            ...
            int128_t res = 0;
            rag3db::function::decimalCast(str.c_str(), str.length(), res, type);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbValueClone(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbValueCopy(JNIEnv* env, jclass, jobject thisValue,
    jobject otherValue) {
    try {
...
JNIEXPORT void JNICALL Java_com_rag3db_Native_rag3dbValueDestroy(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
        delete v;
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbCreateList___3Lcom_rag3db_Value_2(JNIEnv* env,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbCreateList__Lcom_rag3db_DataType_2J(
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbValueGetListSize(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbValueGetListElement(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbValueGetDataType(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbValueGetValue(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbValueToString(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbNodeValGetId(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbNodeValGetLabelName(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbNodeValGetPropertySize(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbNodeValGetPropertyNameAt(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbNodeValGetPropertyValueAt(JNIEnv* env, jclass,
    jobject thisNV, jlong index) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbNodeValToString(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbRelValGetId(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbRelValGetSrcId(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbRelValGetDstId(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbRelValGetLabelName(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbRelValGetPropertySize(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbRelValGetPropertyNameAt(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbRelValGetPropertyValueAt(JNIEnv* env, jclass,
    jobject thisRV, jlong index) {
    try {
        auto* rv = getValue(env, thisRV);
        uint64_t idx = static_cast<uint64_t>(index);
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbRelValToString(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbCreateMap(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_rag3db_Native_rag3dbCreateStruct(JNIEnv* env, jclass,
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbValueGetStructFieldName(JNIEnv* env, jclass,
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbValueGetStructIndex(JNIEnv* env, jclass,
...
JNIEXPORT jstring JNICALL Java_com_rag3db_Native_rag3dbGetVersion(JNIEnv* env, jclass) {
    try {
...
JNIEXPORT jlong JNICALL Java_com_rag3db_Native_rag3dbGetStorageVersion(JNIEnv* env, jclass) {
    try {
...
void initGlobalClassRef(JNIEnv* env) {
    try {
        ...
        createGlobalClassRef(env, J_C_QueryResult, "com/rag3db/QueryResult");

        createGlobalClassRef(env, J_C_PreparedStatement, "com/rag3db/PreparedStatement");

        createGlobalClassRef(env, J_C_DataType, "com/rag3db/DataType");

        createGlobalClassRef(env, J_C_QuerySummary, "com/rag3db/QuerySummary");

        createGlobalClassRef(env, J_C_FlatTuple, "com/rag3db/FlatTuple");

        createGlobalClassRef(env, J_C_Value, "com/rag3db/Value");

        createGlobalClassRef(env, J_C_DataTypeID, "com/rag3db/DataTypeID");
        ...
        createGlobalClassRef(env, J_C_InternalID, "com/rag3db/InternalID");
        ...
        createGlobalClassRef(env, J_C_Connection, "com/rag3db/Connection");

        createGlobalClassRef(env, J_C_Database, "com/rag3db/Database");
