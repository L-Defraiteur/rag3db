...
py::object PyQueryResult::convertValueToPyObject(const Value& value) {
    ...
    case LogicalTypeID::INT128: {
        rag3db::common::int128_t result = value.getValue<rag3db::common::int128_t>();
        std::string int128_string = rag3db::common::Int128_t::toString(result);
    ...
    case LogicalTypeID::UUID: {
        rag3db::common::int128_t result = value.getValue<rag3db::common::int128_t>();
        std::string uuidString = rag3db::common::UUID::toString(result);
...
rag3db::pyarrow::Table PyQueryResult::getAsArrow(std::int64_t chunkSize,
    bool fallbackExtensionTypes) {
    ...
    return py::cast<rag3db::pyarrow::Table>(fromBatchesFunc(batches, schemaObj));
}
