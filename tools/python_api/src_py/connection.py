...
class Connection:
    ...
    def __init__(self, database: Database, num_threads: int = 0):
        """
        Initialise rag3db database connection.
        ...
        """
        self._connection: Any = None  # (type: _rag3db.Connection from pybind11)
    ...
    def init_connection(self) -> None:
        ...
        if self._connection is None:
            self._connection = _rag3db.Connection(self.database._database, self.num_threads)  # type: ignore[union-attr]
