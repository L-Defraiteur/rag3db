...
class QueryResult:
    ...
    def __init__(self, connection: _rag3db.Connection, query_result: _rag3db.QueryResult):  # type: ignore[name-defined]
        """
        Parameters
        ----------
        connection : _rag3db.Connection
            The underlying C++ connection object from pybind11.

        query_result : _rag3db.QueryResult
