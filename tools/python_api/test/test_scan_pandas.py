...
import rag3db
from rag3db.constants import ID, LABEL


def validate_scan_pandas_results(results: rag3db.QueryResult) -> None:
...
def test_scan_py_dict_map_format(conn_db_empty: ConnDB) -> None:
    ...
    # If key and value size don't match, rag3db sniffs it as struct.
