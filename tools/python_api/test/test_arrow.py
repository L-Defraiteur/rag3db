...
from rag3db.constants import ID, LABEL, SRC, DST, NODES
...
def get_result(query_result: rag3db.QueryResult, result_type: str, chunk_size: int | None) -> Any:
...
def test_to_arrow(conn_db_readonly: ConnDB) -> None:
    ...
    def _test_person_table(_conn: rag3db.Connection, return_type: str, chunk_size: int | None = None) -> None:
    ...
    def _test_movies_table(_conn: rag3db.Connection, return_type: str, chunk_size: int | None = None) -> None:
    ...
    def _test_utf8_string(_conn: rag3db.Connection, return_type: str, chunk_size: int | None = None) -> None:
    ...
    def _test_in_small_chunk_size(_conn: rag3db.Connection, return_type: str, chunk_size: int | None = None) -> None:
    ...
    def _test_with_nulls(_conn: rag3db.Connection, return_type: str, chunk_size: int | None = None) -> None:
...
def test_to_arrow_complex(conn_db_readonly: ConnDB) -> None:
    ...
    def _test_node(_conn: rag3db.Connection) -> None:
    ...
    def _test_node_rel(_conn: rag3db.Connection) -> None:
    ...
    def _test_marries_table(_conn: rag3db.Connection) -> None:
    ...
    def _test_recursive_rel(_conn: rag3db.Connection) -> None:
    ...
    def _test_serial(_conn: rag3db.Connection) -> None:
    ...
    def _test_blob(_conn: rag3db.Connection) -> None:
    ...
    def test_to_arrow1(conn: rag3db.Connection) -> None:
