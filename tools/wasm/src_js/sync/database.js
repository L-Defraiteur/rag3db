 ...
 * main class of Rag3db. It manages all database components.
 */
"use strict";
...
class Database {
  ...
  constructor(
    ...
    const defaultSystemConfig = new rag3db.SystemConfig();
    const systemConfig = new rag3db.SystemConfig(
      bufferPoolSize,
      maxNumThreads,
      !!enableCompression,
      !!readOnly,
    ...
    try {
      this._database = new rag3db.Database(databasePath, systemConfig);
    } finally {
      systemConfig.delete();
    }
