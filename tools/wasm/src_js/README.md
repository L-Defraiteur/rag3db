# rag3db-wasm
Welcome to the documentation of `rag3db-wasm`, the WebAssembly build of Rag3db in-process property graph database management system. 
...
For package-level functions, please refer to the documentation of the module `rag3db-wasm` from the sidebar.
