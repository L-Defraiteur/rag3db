/**
 * @file index.js is the root file for the Rag3db WebAssembly module.
...
/**
 * The default asynchronous version of Rag3db WebAssembly module.
 * @module rag3db-wasm
 */
module.exports = {
  /**
   * Initialize the Rag3db WebAssembly module. Calling this function is optional,
  ...
  /**
   * Destroy the Rag3db WebAssembly module and kill the worker. This function
