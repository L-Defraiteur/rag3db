...
const ES_BUILD_CONFIG = {
  entryPoints: ['./build/sync/index.js', './build/index.js', 'build/rag3db_wasm_worker.js'],
  bundle: true,
  format: 'esm',
...
console.log(`Using ${THREADS} threads to build Rag3db.`);
console.log('Cleaning up...');
execSync("npm run clean", { stdio: "inherit" });
console.log('Building single-threaded version of Rag3db WebAssembly module...')
...
console.log("Building multi-threaded version of Rag3db WebAssembly module...");
...
console.log('Cleaning up...');
execSync("npm run clean exclude-package", { stdio: "inherit" });
console.log("Building Node.js version of Rag3db WebAssembly module...");
...
execSync("tar -czf rag3db-wasm.tar.gz package", { cwd: path.resolve("."), stdio: "inherit" });
